...
import {Head, Link, useMutation, useRouter, useRouterQuery, useSession} from "blitz"
          ...
          <div className="px-12 pt-12 space-y-8 md:flex md:justify-between md:px-6 md:space-y-0">
            <div className="flex flex-col my-6 space-y-6 md:m-0">
              ...
              <p className="text-center md:max-w-sm md:text-left text-gray-400">
                Always searching for the neatest buildings. This is actually just a random
                boilerplate for using BlitzJS.
              </p>
            </div>
            ...
            <div className="flex flex-wrap justify-center lg:space-x-8">
              <div className="p-6 md:py-0">
                ...
                <ul className="space-y-1 text-sm text-gray-300">
                  <li>
                    <a className="hover:text-gray-400" href="/components">
                      Components
                    </a>
                  </li>
                  <li>
                    <a className="hover:text-gray-400" href="/templates">
                      Templates
                    </a>
                  </li>
                </ul>
              ...
              <div className="p-6 md:py-0 md:pr-0">
                ...
                <ul className="space-y-1 text-sm text-gray-300">
                  <li>
                    <a className="hover:text-gray-400" href="/docs">
                      Documentation
                    </a>
                  </li>
                  <li>
                    <a className="hover:text-gray-400" href="/docs/credits">
                      Credits
                    </a>
                  </li>
                  <li>
          ...
          <div className="flex flex-col-reverse items-center justify-between p-6 text-center sm:flex-row">
            ...
            <div className="flex space-x-4">
              <a
                ...
                href="mailto:jagoncalves@outlook.pt"
                className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-indigo-600 text-white hover:text-gray-400"
              >
                <svg
              ...
              <a
                ...
                href="https://twitter.com/jagoncalves14"
                className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-indigo-600 text-white hover:text-gray-400"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
              ...
              <a
                aria-label="See the code in GitHub"
                href="https://github.com/jagoncalves14"
                className="flex items-center justify-center w-8 h-8 rounded-full sm:w-10 sm:h-10 bg-indigo-600 text-white hover:text-gray-400"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
